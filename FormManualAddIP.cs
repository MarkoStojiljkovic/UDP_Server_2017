...
namespace UDPServer
{
    public partial class FormManualAddIP : Form
    {
        ...
        private bool validateLocation(TextBox textBox3)
        {
            if (textBox3.Text == "")
            {
                return false; // Empty
        ...
        private void InitFromSettings() // Read from settings file and fill textboxes
        {
            textBox1.Text = Properties.Settings.Default.FormManualMAC;
            textBox2.Text = Properties.Settings.Default.FormManualIP;
            textBox3.Text = Properties.Settings.Default.FormManualLocation;
        }
